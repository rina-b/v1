...
(
    id                  BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    lawyer_id           BIGINT,
    case_description_id BIGINT,
    time                TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_appointments PRIMARY KEY (id)
);

ALTER TABLE appointments
    ADD CONSTRAINT uc_appointments_time UNIQUE (time);

ALTER TABLE appointments
    ADD CONSTRAINT FK_APPOINTMENTS_ON_CASE_DESCRIPTION FOREIGN KEY (case_description_id) REFERENCES case_descriptions (id);

ALTER TABLE appointments
    ADD CONSTRAINT FK_APPOINTMENTS_ON_LAWYER FOREIGN KEY (lawyer_id) REFERENCES lawyers (id);
