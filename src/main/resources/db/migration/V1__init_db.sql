...
ALTER TABLE marks
    ADD CONSTRAINT FK_MARKS_ON_COSTUMER FOREIGN KEY (costumer_id) REFERENCES costumers (id);

ALTER TABLE marks
    ADD CONSTRAINT FK_MARKS_ON_LAWYER FOREIGN KEY (lawyer_id) REFERENCES lawyers (id);
